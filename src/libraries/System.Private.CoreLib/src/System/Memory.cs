...
namespace System
{
    ...
    public readonly struct Memory<T> : IEquatable<Memory<T>>
    {
        ...
        public override string ToString()
        {
            ...
            return $"System.Memory<{typeof(T).Name}>[{self._length}]";
        }
        ...
        public Memory<T> Slice(int start)
        {
            ...
            return new Memory<T>(self._object, self._index + start, self._length - start);
        }
        ...
        public Memory<T> Slice(int start, int length)
        {
            ...
            // It is expected for _index + start to be negative if the memory is already pre-pinned.
            return new Memory<T>(self._object, self._index + start, length);
        }
        ...
        public Span<T> Span
        {
            ...
            get
            {
                ...
                if (self._object != null)
                {
                    ...
                    nuint desiredStartIndex = (uint)self._index & (uint)ReadOnlyMemory<T>.RemoveFlagsBitMask;
        ...
        public override bool Equals([NotNullWhen(true)] object? obj)
        {
            ...
            {
                return ((ReadOnlyMemory<T>)obj).Equals(self);
            }
