...
namespace System.Runtime.InteropServices
{
    ...
    public static partial class MemoryMarshal
    {
        ...
        public static bool TryGetArray<T>(ReadOnlyMemory<T> memory, out ArraySegment<T> segment) =>
            TryGetArrayCore(memory._object, memory._index, memory._length, out segment);
        ...
        internal static bool TryGetArrayCore<T>(object? obj, int index, int length, out ArraySegment<T> segment)
        {
