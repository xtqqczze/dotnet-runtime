...
namespace System.Numerics
{
    public static unsafe partial class Vector
    {
        ...
        internal static void StoreUnsafe(in this Vector3 source, ref float destination)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void StoreUnsafe(in this Vector3 source, ref float destination, nuint elementOffset)
        {
